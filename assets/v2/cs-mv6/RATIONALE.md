...
Strategic role: mission. Claim: The next great network is real life.. Audience emotion: lean-forward belief. Recommended variant: v1-hero when an editorial image exists for this slide; otherwise v2-type because the headline carries more investor force than decorative diagrams.
